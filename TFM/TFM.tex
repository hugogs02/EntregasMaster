...
\title{\begin{center} \Huge Trabajo Final de Máster \newline Aplicación de algoritmos de Machine Learning para predicción de rendimiento de acciones\end{center}} % Article title
\author{
...
\appendix
\section{Anexo: Código}\label{anexo1}
