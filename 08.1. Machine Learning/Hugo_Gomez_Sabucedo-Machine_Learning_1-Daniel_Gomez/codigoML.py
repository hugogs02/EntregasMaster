...
# 2) Numéricas vs target (densidades)
fig, axes = plt.subplots(3, 4, figsize=(18, 12))
axes = axes.flatten()
...
# 3) Categóricas vs target: tasa + soporte
...
# Eliminamos Cylinders por alta correlación
...
# Escalado SOLO en columnas numéricas
...
print("\nMejor modelo final:", best_svm_model)
...
# Añadir Precision, Recall y F1 si no están
